...
+!chooseSwarmToDrive(Swarms)
    ...
    for(.member(Swarm_to_Evaluate, Swarms)){
        ...
        .findall(H, hound_drives(H, Swarm_to_Evaluate) , Drivers_Debug);                                                                                                          //DEBUG
        .print("Drivers close enough: ", Drivers, " Length: ", Len_Drivers, " All Drivers: ", Drivers_Debug);                                                                     //DEBUG                                                                                                                                                     //DEBUG
