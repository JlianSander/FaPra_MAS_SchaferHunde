...
public class get_corral_area extends DefaultInternalAction {
    ...
    private void updateCorral(Location locToProcess){
        Location topLeft = (locToProcess.x < this.corral.tl.x) || ( locToProcess.y < this.corral.tl.y) ? locToProcess : this.corral.tl;
        Location bottomRight = ( locToProcess.x > this.corral.br.x) || (locToProcess.y > this.corral.br.y) ? locToProcess : this.corral.br;
